    ...
    <section class="auth-form-section">
        <div class="form-container">
            <header class="form-header">
                <h1 class="form-title">Verifier Registration</h1>
                <p class="form-subtitle">Join the credential verification network</p>
            </header>
            ...
            <form id="kc-register-form" action="${url.registrationAction}" method="post" class="auth-form">
                ...
                <footer class="form-footer">
                    <span class="form-footer-text">Already have verifier access?</span>
