...
<#if section = "header">
    <title>CSIMS - Credential Verification Portal</title>
    ...
    <section class="auth-form-section">
        <div class="form-container">
            <header class="form-header">
                <h1 class="form-title">Verifier Access</h1>
                <p class="form-subtitle">Sign in to verify academic credentials</p>
            </header>
              ...
              <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post" class="auth-form">
                ...
                <#if realm.password && realm.registrationAllowed && !registrationDisabled??>
                  <footer class="form-footer">
                      <span class="form-footer-text">Need verifier access?</span>
        ...
        <div class="illustration-content">
            ...
            <div class="illustration-placeholder">
                <svg class="placeholder-icon" viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <circle cx="200" cy="120" r="25" fill="white" fill-opacity="0.3"/>
                    <path d="M185 120L195 130L215 110" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                    <rect x="70" y="160" width="260" height="15" rx="3" fill="white" fill-opacity="0.2"/>
                    <rect x="70" y="185" width="200" height="12" rx="3" fill="white" fill-opacity="0.2"/>
                    <rect x="70" y="205" width="180" height="12" rx="3" fill="white" fill-opacity="0.2"/>
                    <rect x="280" y="180" width="50" height="30" rx="5" fill="white" fill-opacity="0.3"/>
                    <path d="M295 190L300 195L310 185" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </div>
            ...
            <div class="feature-highlights">
                ...
                <div class="feature-item">
                    ...
                    <span>QR Code Scanning & Validation</span>
                </div>
                <div class="feature-item">
                    <svg class="feature-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
