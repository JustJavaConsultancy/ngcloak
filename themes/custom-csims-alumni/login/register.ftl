        ...
        <div class="illustration-content">
            ...
            <div class="illustration-placeholder">
                <svg class="placeholder-icon" viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <!-- Graduation cap -->
                    <path d="M200 80L120 110L200 140L280 110L200 80Z" fill="white" fill-opacity="0.3" stroke="white" stroke-width="2"/>
                    <path d="M280 110V150C280 160 250 170 200 170C150 170 120 160 120 150V110" stroke="white" stroke-width="2" fill="none"/>
                    <!-- Tassel -->
                    <circle cx="290" cy="105" r="4" fill="white" fill-opacity="0.4"/>
                    <path d="M290 105L295 115L285 115Z" fill="white" fill-opacity="0.4"/>
                    <!-- Diploma -->
                    <rect x="150" y="190" width="100" height="70" rx="5" fill="white" fill-opacity="0.2" stroke="white" stroke-width="2"/>
                    <path d="M160 210L240 210M160 220L220 220M160 230L230 230" stroke="white" stroke-width="1.5" stroke-linecap="round"/>
                    <!-- Ribbon -->
                    <path d="M240 190L260 190L255 210L250 200L245 210L240 190" fill="white" fill-opacity="0.3"/>
                    <!-- Student figure -->
                    <circle cx="200" cy="50" r="15" fill="white" fill-opacity="0.2"/>
                    <path d="M185 65L215 65L210 85L190 85Z" fill="white" fill-opacity="0.2"/>
                </svg>
            </div>
