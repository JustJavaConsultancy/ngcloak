...
<div class="desktop-background fixed top-0 left-0 w-full h-full overflow-hidden z-0">
    <div class="absolute -top-20 -left-20 w-72 h-72 bg-emerald-200 rounded-full opacity-20 animate-float"></div>
    <div class="absolute top-1/4 -right-20 w-64 h-64 bg-teal-200 rounded-full opacity-20 animate-float"></div>
    <div class="absolute bottom-20 left-1/4 w-56 h-56 bg-green-200 rounded-full opacity-20 animate-float"></div>
    <div class="absolute bottom-0 right-1/4 w-48 h-48 bg-emerald-300 rounded-full opacity-20 animate-float"></div>
</div>
...
<h1 class="text-2xl font-bold">The Friendship</h1>
        ...
        <div class="max-w-md animate-fade-in" style="animation-delay: 0.3s">
            ...
            <p class="text-lg opacity-90 mb-8 comtext">Become a member-owner and enjoy better rates, lower fees, and personalized service from your local cooperative.</p>
            <div class="space-y-6">
                <div class="flex items-center">
                    <div class="flex-shrink-0 h-10 w-10 rounded-full bg-white bg-opacity-20 flex items-center justify-center mr-4">
                        <i class="fas fa-percentage text-white"></i>
                    </div>
                    <p class="text-lg comtext">Better rates on loans & savings</p>
                </div>
                <div class="flex items-center">
                    <div class="flex-shrink-0 h-10 w-10 rounded-full bg-white bg-opacity-20 flex items-center justify-center mr-4">
                        <i class="fas fa-handshake text-white"></i>
                    </div>
                    <p class="text-lg comtext">Personalized financial guidance</p>
                </div>
                <div class="flex items-center">
                    <div class="flex-shrink-0 h-10 w-10 rounded-full bg-white bg-opacity-20 flex items-center justify-center mr-4">
                        <i class="fas fa-heart text-white"></i>
                    </div>
                    <p class="text-lg comtext">Community-focused banking</p>
                </div>
            </div>
        </div>
    ...
    <div class="responsive-right-panel w-1/2 flex items-center justify-center p-8">
        <div class="w-full max-w-md">
            <div class="glass-effect rounded-2xl shadow-xl p-8 animate-fade-in">
                <h2 class="text-2xl font-bold text-gray-800 mb-2">Become a member</h2>
                <p class="text-gray-600 mb-6 text-sm">Join our cooperative community today</p>
                ...
                <form id="kc-register-form-desktop" action="${url.registrationAction}" method="post" class="space-y-5">
                    ...
                    <div class="flex gap-4">
                        <div class="w-1/2">
                            ...
                            <input type="text" id="firstName-desktop" name="firstName"
                                   class="input-focus px-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 w-full"
                    ...
                    <div class="relative">
                        ...
                        <input type="password" id="password-desktop" name="password"
                               class="input-focus px-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 w-full pr-10"
                    ...
                    <button type="submit" id="register-btn-desktop"
                            class="animate-gradient w-full py-3 px-4 rounded-lg text-white font-medium btn-transition focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 opacity-50 cursor-not-allowed">
                        ${msg("doRegister")}
                    </button>

                    <p class="text-center text-sm text-gray-600 mt-4">
                        Already a member? <a href="${url.loginUrl}" class="text-emerald-600 hover:underline">Sign in</a>
                    </p>
                </form>
            </div>
        </div>
        ...
        <div class="mobile-form-container">
                ...
                <form id="kc-register-form-mobile" action="${url.registrationAction}" method="post" class="space-y-6">
                    ...
                    <div class="mobile-slide-down" style="animation-delay: 0.8s">
                        <button type="submit" id="register-btn-mobile"
                                class="animate-gradient mobile-btn-active mobile-touch-target mobile-button w-full text-white focus:outline-none focus:ring-4 focus:ring-emerald-300 transition-all duration-200 opacity-50 cursor-not-allowed"
                                disabled>
                            ${msg("doRegister")}
                        </button>
                    </div>
            ...
            <div class="text-center mt-8 mobile-slide-down" style="animation-delay: 0.9s">
                <p class="text-gray-600">
                    Already a member?
                    <a href="${url.loginUrl}" class="text-emerald-600 font-semibold">Sign in</a>
                </p>
            </div>
            ...
            <div class="mt-8 space-y-3 mobile-slide-down" style="animation-delay: 1s">
                <div class="flex items-center space-x-3 text-sm text-gray-600">
                    ...
                    <span>Better rates on loans & savings</span>
                </div>
                <div class="flex items-center space-x-3 text-sm text-gray-600">
                    <i class="fas fa-check-circle text-green-500"></i>
...
<script>
    ...
    function setupMobileValidation() {
        ...
        document.getElementById('kc-register-form-mobile').addEventListener('submit', function(e) {
            ...
            registerBtn.innerHTML = '<i class="fas fa-spinner fa-spin mr-2"></i>Creating membership...';
        });
    }
