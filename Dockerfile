...
ENV KC_SPI_EVENTS_LISTENER_ACCOUNT_LOCK_LISTENER_SERVER_URL=https://ngcloak.onrender.com
ENV KC_SPI_EVENTS_LISTENER_ACCOUNT_LOCK_LISTENER_CLIENT_ID=admin-client
ENV KC_SPI_EVENTS_LISTENER_ACCOUNT_LOCK_LISTENER_CLIENT_SECRET=Q9G8MRU3WRcIyw4prqVZeD2YNljvNFAh
