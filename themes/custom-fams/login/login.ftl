    ...
    <main class="flex min-h-screen red-pattern-dots">
      ...
      <section class="hidden lg:flex flex-col w-1/2 relative overflow-hidden p-margin-desktop left-panel">
        ...
        <div class="relative z-10 flex flex-col h-full justify-between">
          ...
          <!-- Hero image with crimson overlay -->
          <div class="flex-grow flex items-center justify-center py-8">
            <div class="w-full rounded-2xl overflow-hidden relative shadow-2xl shadow-black/30" style="height: 420px;">
              <img
                ...
                onerror="this.src='https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=900&q=85'"
              >
      ...
      <!-- ═══════════════════════════════════════════════
           RIGHT PANEL — warm red-tinted form surface
           ═══════════════════════════════════════════════ -->
          ...
          <div class="form-container">
            <div class="form-flip-inner relative" id="form-inner">
              ...
              <div class="form-front">
                ...
                >
                  ...
                  <div>
                    ...
                    <input
                      class="fams-input <#if messagesPerField.existsError('username')>fams-input-error</#if>"
                      id="username"
                      name="username"
                  ...
                  <div>
                    ...
                    <div class="relative">
                      <input
                        class="fams-input <#if messagesPerField.existsError('password')>fams-input-error</#if>"
                        id="password"
                        name="password"
                        placeholder="••••••••"
                        type="password"
                  ...
                  <#if realm.rememberMe && !usernameEditDisabled??>
                    <div class="flex items-center gap-3">
                      <input
                        class="custom-checkbox w-5 h-5 rounded border-outline-variant text-primary focus:ring-primary focus:ring-1"
                        id="rememberMe"
                        name="rememberMe"
                        type="checkbox"
                        <#if login.rememberMe??>checked</#if>
                      >
                      <label class="font-body-md text-secondary select-none" for="rememberMe">
                        ${msg("rememberMe")}
                      </label>
                    </div>
                  </#if>
              ...
              <div class="form-back">
                ...
                <form class="space-y-6" action="${url.loginResetCredentialsUrl}" method="get">
                  <div>
                  ...
                  <button
                    class="w-full flex items-center justify-center gap-2 text-secondary hover:text-primary transition-colors font-label-sm py-2"
                    onclick="flipForm()"
                    type="button"
                  >
