...
<#if section = "header">
    <title>Cooperative Loans & Savings - Login</title>
    ...
    <style>
        ...
        .animate-gradient {
            background: linear-gradient(-45deg, #059669, #0d9488, #059669);
...
<div class="desktop-background fixed top-0 left-0 w-full h-full overflow-hidden z-0">
    <div class="absolute -top-20 -left-20 w-72 h-72 bg-emerald-200 rounded-full opacity-20 animate-float" style="animation-delay: 0s"></div>
    <div class="absolute top-1/4 -right-20 w-64 h-64 bg-teal-200 rounded-full opacity-20 animate-float" style="animation-delay: 1s"></div>
    <div class="absolute bottom-20 left-1/4 w-56 h-56 bg-green-200 rounded-full opacity-20 animate-float" style="animation-delay: 2s"></div>
    <div class="absolute bottom-0 right-1/4 w-48 h-48 bg-emerald-300 rounded-full opacity-20 animate-float" style="animation-delay: 3s"></div>
</div>

<!-- Mobile background -->
<div class="mobile-background fixed inset-0 overflow-hidden z-0">
    <div class="absolute -top-10 -left-10 w-40 h-40 bg-emerald-200 rounded-full opacity-20"></div>
    <div class="absolute top-1/4 -right-10 w-32 h-32 bg-teal-200 rounded-full opacity-20"></div>
    <div class="absolute bottom-20 left-1/4 w-28 h-28 bg-green-200 rounded-full opacity-20"></div>
</div>
...
<div class="desktop-layout min-h-screen relative z-10">
    ...
    <div class="desktop-left-panel w-1/2 p-12 bg-gradient-to-br from-emerald-600 to-teal-600 text-white">
        ...
        <div class="max-w-md animate-fade-in" style="animation-delay: 0.3s">
            <h2 class="text-4xl font-bold mb-6">Your financial partner for life</h2>
            <p class="text-lg opacity-90 mb-8 comtext">Join our cooperative community and take control of your financial future with competitive loans, high-yield savings, and member benefits.</p>
            <div class="space-y-6">
                <div class="flex items-center">
                    ...
                    <p class="text-lg comtext">High-yield savings accounts</p>
                </div>
                <div class="flex items-center">
                    <div class="flex-shrink-0 h-10 w-10 rounded-full bg-white bg-opacity-20 flex items-center justify-center mr-4">
                        <i class="fas fa-hand-holding-usd text-white"></i>
                    </div>
                    <p class="text-lg comtext">Low-interest loans & credit</p>
                </div>
                <div class="flex items-center">
                    <div class="flex-shrink-0 h-10 w-10 rounded-full bg-white bg-opacity-20 flex items-center justify-center mr-4">
                        <i class="fas fa-users text-white"></i>
                    </div>
                    <p class="text-lg comtext">Member-owned cooperative</p>
                </div>
            </div>
        </div>
        <div class="animate-fade-in" style="animation-delay: 0.6s">
            <div class="flex items-center space-x-2 mb-4">
                <div class="w-8 h-8 rounded-full border-2 border-white overflow-hidden">
                    <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=100&amp;q=80" alt="Member" class="w-full h-full object-cover">
                </div>
                <div class="w-8 h-8 rounded-full border-2 border-white overflow-hidden">
                    <img src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=100&amp;q=80" alt="Member" class="w-full h-full object-cover">
                </div>
                <div class="w-8 h-8 rounded-full border-2 border-white overflow-hidden">
                    <img src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=100&amp;q=80" alt="Member" class="w-full h-full object-cover">
                </div>
                <div class="w-8 h-8 rounded-full border-2 border-white overflow-hidden">
                    <img src="https://images.unsplash.com/photo-1519345182560-3f2917c472ef?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=100&amp;q=80" alt="Member" class="w-full h-full object-cover">
                </div>
            </div>
    ...
    <div class="responsive-right-panel w-1/2 flex items-center justify-center p-8">
        <div class="w-full max-w-md">
            <div class="glass-effect rounded-2xl shadow-xl p-8 animate-fade-in" style="animation-delay: 0.2s">
                ...
                <p class="text-gray-600 mb-6 text-sm">Access your cooperative account</p>
                ...
                <form id="kc-form-login-desktop" class="space-y-5" action="${url.loginAction}" method="post">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="username-desktop" name="username"
                                   ...
                                   class="input-focus pl-10 pr-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 w-full transition-all duration-200"
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-1">
                            ...
                            <#if realm.resetPasswordAllowed>
                                <a href="${url.loginResetCredentialsUrl}" class="text-sm text-emerald-600 hover:text-emerald-800 transition-colors">${msg("doForgotPassword")}</a>
                            </#if>
                        </div>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    ...
                    <#if realm.rememberMe>
                        <div class="flex items-center">
                            <input type="checkbox" id="rememberMe-desktop" name="rememberMe"
                                   class="checkbox h-4 w-4 text-emerald-600 focus:ring-emerald-500 border-gray-300 rounded"
                    ...
                    <div>
                        ...
                        <button type="submit" id="kc-login-desktop"
                                class="animate-gradient w-full py-3 px-4 rounded-lg text-white font-medium btn-transition focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500">
                            ${msg("doLogIn")}
                        </button>
                    </div>
                </form>
            ...
            <#if realm.password && realm.registrationAllowed && !registrationDisabled??>
                <p class="text-center text-sm text-gray-600 mt-4">
                    Not a member yet?
                    <a href="${url.registrationUrl}" class="text-emerald-600 hover:underline">Join our cooperative</a>
                </p>
            </#if>
        </div>
    </div>
                ...
                <form id="kc-form-login-mobile" action="${url.loginAction}" method="post" class="space-y-6">
                    ...
                    <div class="mobile-slide-down" style="animation-delay: 0.4s">
                        <div class="flex justify-between items-center mb-3">
                            ...
                            <#if realm.resetPasswordAllowed>
                                <a href="${url.loginResetCredentialsUrl}" class="text-sm text-emerald-600 font-medium">Forgot?</a>
                            </#if>
                        </div>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 mobile-icon-container flex items-center pointer-events-none">
                    ...
                    <div class="mobile-slide-down" style="animation-delay: 0.6s">
                        ...
                        <button type="submit" id="kc-login-mobile"
                                class="animate-gradient mobile-btn-active mobile-touch-target mobile-button w-full text-white focus:outline-none focus:ring-4 focus:ring-emerald-300 transition-all duration-200">
                            ${msg("doLogIn")}
                        </button>
                    </div>
                </form>
            ...
            <#if realm.password && realm.registrationAllowed && !registrationDisabled??>
                <div class="text-center mt-8 mobile-slide-down" style="animation-delay: 0.7s">
                    <p class="text-gray-600">
                        Not a member yet?
                        <a href="${url.registrationUrl}" class="text-emerald-600 font-semibold">Join our cooperative</a>
                    </p>
                </div>
            </#if>
            ...
            <div class="mt-8 text-center mobile-slide-down" style="animation-delay: 0.8s">
                <div class="flex justify-center items-center space-x-4 mb-4">
                    <div class="flex items-center space-x-1">
                        ...
                        <span class="text-xs text-gray-600 font-medium">FDIC Insured</span>
                    </div>
                    <div class="flex items-center space-x-1">
                    ...
                    <div class="flex items-center space-x-1">
                        ...
                        <span class="text-xs text-gray-600 font-medium">Member-Owned</span>
                    </div>
                </div>
                <p class="text-xs text-gray-500">
                    Trusted by thousands of members since 1952
                </p>
            </div>
        </div>
    </div>
